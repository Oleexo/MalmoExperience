...
#ifndef C__TIM_MALMO_GITHUB_SCHEMAS_MISSION_HANDLERS_H
#define C__TIM_MALMO_GITHUB_SCHEMAS_MISSION_HANDLERS_H
...
namespace malmo
{
  namespace schemas
  {
    ...
    class VariantList: public ::xml_schema::simple_type,
      public ::xsd::cxx::tree::list< ::malmo::schemas::BlockVariant, char >
    {
      public:
      VariantList ();

      VariantList (size_type n, const ::malmo::schemas::BlockVariant& x);

      template < typename I >
      VariantList (const I& begin, const I& end)
      : ::xsd::cxx::tree::list< ::malmo::schemas::BlockVariant, char > (begin, end, this)
      {
      }
    ...
    class DiscreteMovementCommand: public ::xml_schema::string
    {
      ...
      public:
      static const char* const _xsd_DiscreteMovementCommand_literals_[8];
      static const value _xsd_DiscreteMovementCommand_indexes_[8];
    };
    ...
    class Command: public ::xml_schema::string
    {
      ...
      public:
      static const char* const _xsd_Command_literals_[33];
      static const value _xsd_Command_indexes_[33];
    };
    ...
    class RewardForCollectingItem: public ::xml_schema::type
    {
      ...
      // Item
      //
      typedef ::malmo::schemas::ItemSpec Item_type;
    ...
    class Waypoints: public ::xml_schema::type
    {
      ...
      // WaypointItem
      //
      typedef ::malmo::schemas::BlockOrItemList WaypointItem_type;
...
#endif // C__TIM_MALMO_GITHUB_SCHEMAS_MISSION_HANDLERS_H
