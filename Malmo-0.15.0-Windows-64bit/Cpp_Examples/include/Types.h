...
#ifndef C__TIM_MALMO_GITHUB_SCHEMAS_TYPES_H
#define C__TIM_MALMO_GITHUB_SCHEMAS_TYPES_H
...
namespace malmo
{
  namespace schemas
  {
    ...
    class BlockVariant: public ::xml_schema::string
    {
      public:
      enum value
      {
      ...
      BlockVariant (value v);

      BlockVariant (const char* v);

      BlockVariant (const ::std::string& v);

      BlockVariant (const ::xml_schema::string& v);

      BlockVariant (const ::xercesc::DOMElement& e,
                    ::xml_schema::flags f = 0,
                    ::xml_schema::container* c = 0);

      BlockVariant (const ::xercesc::DOMAttr& a,
                    ::xml_schema::flags f = 0,
                    ::xml_schema::container* c = 0);

      BlockVariant (const ::std::string& s,
                    const ::xercesc::DOMElement* e,
                    ::xml_schema::flags f = 0,
                    ::xml_schema::container* c = 0);

      BlockVariant (const BlockVariant& x,
                    ::xml_schema::flags f = 0,
                    ::xml_schema::container* c = 0);

      virtual BlockVariant*
      _clone (::xml_schema::flags f = 0,
              ::xml_schema::container* c = 0) const;
      ...
      operator value () const
      {
        return _xsd_BlockVariant_convert ();
      }

      protected:
      value
      _xsd_BlockVariant_convert () const;

      public:
      static const char* const _xsd_BlockVariant_literals_[13];
      static const value _xsd_BlockVariant_indexes_[13];
    };
  }
}
...
namespace malmo
{
  namespace schemas
  {
    ...
    void
    operator<< (::xercesc::DOMElement&, const BlockVariant&);

    void
    operator<< (::xercesc::DOMAttr&, const BlockVariant&);
...
#endif // C__TIM_MALMO_GITHUB_SCHEMAS_TYPES_H
